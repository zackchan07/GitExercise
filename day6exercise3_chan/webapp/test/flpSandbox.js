		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Navigation",
									"targetURL": "#day6exercise3chan-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"day6exercise3chan-display": {
								"semanticObject": "day6exercise3chan",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=day6exercise3chan",
									"url": sap.ui.require.toUrl("day6exercise3chan")
								}
							}
						}
					}
