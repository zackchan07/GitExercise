		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Demo App",
									"targetURL": "#demojackdemoapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"demojackdemoapp-display": {
								"semanticObject": "demojackdemoapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demo.jack.demoapp",
									"url": sap.ui.require.toUrl("demo/jack/demoapp")
								}
							}
						}
					}
