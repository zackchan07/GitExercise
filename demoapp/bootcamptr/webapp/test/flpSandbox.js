		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zbtpbootcamptr-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbtpbootcamptr-display": {
								"semanticObject": "zbtpbootcamptr",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbtp.bootcamptr",
									"url": sap.ui.require.toUrl("zbtp/bootcamptr")
								}
							}
						}
					}
